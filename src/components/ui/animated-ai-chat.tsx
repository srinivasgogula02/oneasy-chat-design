        ...
        <div className="min-h-screen flex flex-col w-full items-center justify-center bg-transparent text-white p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    ...
                    >
                        <div className="p-4 space-y-4 max-h-[60vh] overflow-y-auto mb-4">
                            {messages.length === 0 && (
                            ...
                            {messages.map((msg, index) => (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    className={cn(
                                        "flex w-full items-start gap-4 p-4 rounded-xl",
                                        msg.role === "user" ? "bg-white/5" : "bg-transparent border border-white/5"
                                    )}
                                >
                                    <div className={cn(
                                        ...
                                        {msg.role === "user" ? <CircleUserRound className="w-4 h-4" /> : <Sparkles className="w-4 h-4 text-violet-400" />}
                                    </div>
