...
function createFallbackResponse(profile: UserProfile, errorMessage: string): LLMResponse {
    ...
    return {
        ...
        suitability_analysis: {
            ...
            "Section 8 Company": { score: 50, reason: "Insufficient data", is_excluded: false },
            "Trust": { score: 50, reason: "Insufficient data", is_excluded: false },
            "Society": { score: 50, reason: "Insufficient data", is_excluded: false },
        },
